        ...
        <div className="portfolio-card">
          ...
          <div className="bg-gradient-to-r from-blue-50 to-blue-100 p-6 rounded-lg mb-6 border-l-4 border-[#0095d5]">
            ...
            <p className="text-lg leading-relaxed text-gray-700">
              <strong>Former Big Tech Company Developer</strong> with
              enterprise-level experience in building scalable web applications.
              I bring Fortune 500 company standards and practices to every
              project.
            </p>
          </div>
          <p className="text-lg leading-relaxed mb-6">
            ...
            , where I worked on enterprise-scale applications and learned
            industry best practices. My development journey started in Summer
            2017 with my first internship at a startup in Lubbock, TX.
          </p>
          <p className="text-lg leading-relaxed mb-6">
            Having worked at HP, I bring enterprise-level expertise to web
            development, including scalable architecture patterns, code quality
            standards, and collaborative development practices. I'm now seeking
            new opportunities to apply this Fortune 500 experience to innovative
            projects. If you're an employer looking for a developer with proven
      ...
      <div className="max-w-4xl mx-auto mb-8">
        <div className="portfolio-card bg-gradient-to-br from-blue-50 to-white border-2 border-[#0095d5]">
          <div className="flex items-center mb-6">
            ...
            <div className="text-2xl font-bold text-[#0095d5]">
              Brownsville & RGV
            </div>
          </div>

          <h2 className="text-3xl font-bold mb-4 text-[#0095d5]">
            Website Development for Local Businesses
          </h2>

          <p className="text-lg leading-relaxed mb-4 text-gray-700">
            Bringing <strong>Fortune 500 development standards</strong> to small
            and local businesses in
            <strong className="text-[#0095d5]"> Brownsville, Texas</strong> and
            throughout the
            <strong className="text-[#0095d5]"> Rio Grande Valley (RGV)</strong>
            . I specialize in creating professional, modern websites that help
            local businesses establish their digital presence and compete
            effectively.
          </p>

          <div className="grid md:grid-cols-2 gap-6 mb-6">
            <div>
              <h3 className="text-xl font-semibold mb-3 text-[#0095d5]">
                Services Offered:
              </h3>
            ...
            <div>
              <h3 className="text-xl font-semibold mb-3 text-[#0095d5]">
                Why Choose Enterprise Experience:
              </h3>
              <ul className="space-y-2">
                <li className="flex items-start">
          ...
          <div className="bg-[#0095d5] text-white p-4 rounded-lg text-center">
            <p className="text-lg mb-3">
              <strong>
                Ready to elevate your local business with enterprise-grade web
                development?
              </strong>
            </p>
            <a
